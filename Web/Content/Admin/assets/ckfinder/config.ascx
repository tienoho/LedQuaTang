...
<script runat="server">
	...
	public override void SetConfig()
	{
		...
		PluginSettings.Add("ImageResize_smallThumb", "100x100" );
		PluginSettings.Add("ImageResize_mediumThumb", "170x170" );
		PluginSettings.Add("ImageResize_largeThumb", "220x220" );
		...
		Thumbnails.MaxWidth = 220;
        Thumbnails.MaxHeight = 220;
