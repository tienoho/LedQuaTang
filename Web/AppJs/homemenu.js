var homemenu = function () {
    return {
        ...
        loadData: function (pageindex) {
            var self = this;
            $("#loading").show();
            AjaxService.POST("/Admin/homemenu/ListData", {page: pageindex}, function (res) {
        ...
        onEditSuccess: function (res) {
            ...
            if (res.IsSuccess == true) {
                alertmsg.success(res.Messenger);
                homemenu.loadData(parseInt(page));
                modal.hide();
            } else {
                alertmsg.error(res.Messenger);
            }
        ...
        active: function (id) {
            ...
            swal({
                ...
                if (isConfirm) {
                    AjaxService.POST("/Admin/homemenu/EditComment", { id: id }, function (res) {
                        self.pageIndex = 1;
